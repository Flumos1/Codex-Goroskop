...
// Note: OCR may misread 'Д' as 'А' in 'ДВАДЦАТЬ', so we add OCR-error variants
const ORDINAL_MAP = {
  ...
  "ДВАДЦАТОЕ": 20, "АВАДЦАТОЕ": 20,                         // OCR variant
  "ДВАДЦАТЬ ПЕРВОЕ": 21,  "АВАДЦАТЬ ПЕРВОЕ": 21,            // OCR variants
  "ДВАДЦАТЬ ВТОРОЕ": 22,  "АВАДЦАТЬ ВТОРОЕ": 22,
  "ДВАДЦАТЬ ТРЕТЬЕ": 23,  "АВАДЦАТЬ ТРЕТЬЕ": 23,
  "ДВАДЦАТЬ ЧЕТВЕРТОЕ": 24, "ДВАДЦАТЬ ЧЕТВЁРТОЕ": 24,
  "АВАДЦАТЬ ЧЕТВЕРТОЕ": 24, "АВАДЦАТЬ ЧЕТВЁРТОЕ": 24,
  "ДВАДЦАТЬ ПЯТОЕ": 25,   "АВАДЦАТЬ ПЯТОЕ": 25,
  "ДВАДЦАТЬ ШЕСТОЕ": 26,  "АВАДЦАТЬ ШЕСТОЕ": 26,
  "ДВАДЦАТЬ СЕДЬМОЕ": 27, "АВАДЦАТЬ СЕДЬМОЕ": 27,
  "ДВАДЦАТЬ ВОСЬМОЕ": 28, "АВАДЦАТЬ ВОСЬМОЕ": 28,
  "ДВАДЦАТЬ ДЕВЯТОЕ": 29, "АВАДЦАТЬ ДЕВЯТОЕ": 29,
  "ТРИДЦАТОЕ": 30,
  "ТРИДЦАТЬ ПЕРВОЕ": 31,
};
