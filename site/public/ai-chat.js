const aiQuestionSets = {
  ...
  numerology: [
    "Что значит мое число жизненного пути на практике?",
    "Как число экспрессии влияет на выбор работы?",
    "Чего на самом деле хочет число моей души?",
    "Почему число личности может отличаться от числа души?",
    "Что важно сделать в этом персональном году?",
    "Как использовать персональный месяц уже сейчас?",
    "Какая тень чисел мешает мне сильнее всего?",
    "Как совместить число жизненного пути с работой?",
    "Какой практический шаг предложить на эту неделю?",
    "Сделай честный итог без мистики и фатальности.",
  ],
  rhythms: [
